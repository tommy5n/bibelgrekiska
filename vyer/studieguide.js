...
const SEMINARIER = [
  ...
  },
  {
    ...
    nytt:[
      ...
      "Bisatser och subjunktioner (ὅτι, ὅτε, ὡς, εἰ, ἵνα, ὥστε …)",
      "Tredje deklinationens neutra — τὸ πνεῦμα, τὸ ὄρος, τὸ φῶς",
      "Presens particip — verbet som böjs som ett adjektiv (λύων, λύουσα, λῦον)",
    ],
    begrepp:[
      { rubrik:"Aspekt: aorist vid sidan av imperfekt",
        text:"Grekiskan har två dåtidstempus. Imperfekt (sem 7) ser handlingen som <i>pågående</i> eller upprepad (<span class='grek'>ἐζήτουν</span> ’de höll på att söka’); <b>aorist</b> ser den som en <i>helhet</i>, en avslutad händelse (<span class='grek'>ἐποίησεν</span> ’han gjorde’). Skillnaden är inte tid utan <b>aspekt</b> — samma dåtid, olika synsätt." },
      { rubrik:"Sigmatisk aorist = augment + σ + α-ändelser",
        text:"Aoristen kombinerar två saker du redan kan: <b>augmentet</b> från imperfekt och <b>σ-tecknet</b> från futurum. På det läggs egna ändelser: <span class='grek'>-α, -ας, -ε(ν), -αμεν, -ατε, -αν</span>. Så <span class='grek'>λύω → ἔ-λυ-σ-α</span>, <span class='grek'>πέμπω → ἔ-πεμ-ψ-α</span>. σ möter rotens slutljud med samma ljudlagar som i futurum (π/φ/β→ψ, κ/χ/γ→ξ, τ/θ/δ→σ)." },
      { rubrik:"Bisatsen bärs av en subjunktion",
        text:"En <b>bisats</b> har ett eget predikat men kan inte stå själv — den inleds av en <b>subjunktion</b> som binder den till huvudsatsen: <span class='grek'>ὅτι</span> (att/eftersom), <span class='grek'>ὅτε</span> (när), <span class='grek'>ὡς</span> (då/när), <span class='grek'>εἰ</span> (om), <span class='grek'>ἵνα</span> (för att), <span class='grek'>ὥστε</span> (så att). Efter säge- och förnimmelseverb (λέγω, ἀκούω, βλέπω) fungerar en <span class='grek'>ὅτι</span>-sats som ett slags objekt." },
      { rubrik:"Tredje deklinationens neutra",
        text:"Neutra i tredje deklinationen slutar oftast på <span class='grek'>-α</span> eller <span class='grek'>-ος</span> i nominativ och böjs på <i>genitivstammen</i>: <span class='grek'>τὸ πνεῦμα, πνεύματ-ος</span> (typ -ματος) och <span class='grek'>τὸ ὄρος, ὄρ-ους</span> (typ -ους). Som alla neutra är nominativ = ackusativ, i både singular och plural." },
      { rubrik:"Presens particip — verbet som adjektiv",
        text:"Ett <b>particip</b> är ett verbaladjektiv. Presens particip aktiv bildas <span class='grek'>-ων, -ουσα, -ον</span> (<span class='grek'>λύων, λύουσα, λῦον</span> ’lösande’) och böjs som ett treändelseadjektiv som <b>kongruerar</b> med sitt huvudord: maskulinum/neutrum efter tredje deklinationen (-οντ-), femininum efter första (-ουσ-)." },
    ],
    fallor:[
      "<b>Aorist imperativ och infinitiv tappar augmentet:</b> <span class='grek'>λῦσον</span> ’lös!’ och <span class='grek'>λῦσαι</span> ’att lösa’ — inte <span class='grek'>ἐλυσ-</span>. Augmentet hör bara till indikativen.",
      "<b>καλέω avviker:</b> aoristen är <span class='grek'>ἐκάλεσα</span> (kort ε), inte <span class='grek'>ἐκάλησα</span> — trots att -έω-verb annars förlänger ε till η framför σ.",
      "<b>ἐποίει vs ἐποίησεν:</b> imperfekt (’höll på att göra’) mot aorist (’gjorde’). Samma verb, olika aspekt — och bara <span class='grek'>-σ-</span> och ändelsen skiljer dem åt.",
      "<b>Sammansatta verb augmenteras inne i ordet:</b> <span class='grek'>κατα-βαίνω → κατ-έ-βαινεν</span>, <span class='grek'>ἀνα-γινώσκω → ἀν-ε-γίνωσκεν</span> (elision). Augmentet hamnar mellan prepositionen och verbstammen.",
      "<b>Neutrernas två genitivmönster:</b> nominativ på <span class='grek'>-α</span> ger genitiv <span class='grek'>-ατος</span> (πνεῦμα → πνεύματος), nominativ på <span class='grek'>-ος</span> ger <span class='grek'>-ους</span> (ὄρος → ὄρους). Blanda inte ihop dem.",
      "<b>φῶς och ὕδωρ</b> har avvikande nominativ men böjs som <span class='grek'>πνεῦμα</span> på stammen (<span class='grek'>φωτ-, ὑδατ-</span>): <span class='grek'>φωτός, ὕδατος</span>.",
    ],
    ova:[
      ...
      { spel:"Presens particip", route:"#/particip", vad:"välj den participform som kongruerar med huvudordet" },
      { spel:"Glosor", route:"#/glosor", filter:"Sem 8", vad:"det nyaste ordförrådet — neutra, subjunktioner och aorist-verb" },
    ],
    gor:[
      { text:"Självstudium (14 meningar)", anchor:"sem8-sjalvstudium" },
      { text:"Breakout 1: imperfekt", anchor:"sem8-breakout-1" },
      { text:"Breakout 2: sigmatisk aorist", anchor:"sem8-breakout-2" },
      { text:"Breakout 3: bisatser & 3:e dekl.", anchor:"sem8-breakout-3" },
      { text:"Presentationens ὅτι-satser", anchor:"sem8-presentation" },
    ],
    slaupp:[
      { text:"Sigmatisk aorist", anchor:"verb-aorist" },
      { text:"Imperfekt vs. aorist", anchor:"verb-jmf-datid" },
      { text:"Infinitiv: presens vs. aorist", anchor:"verb-jmf-inf" },
      { text:"Samma verb i alla former", anchor:"verb-jmf-system" },
      { text:"Presens particip", anchor:"verb-particip" },
      { text:"Bisatser & subjunktioner", anchor:"bisatser" },
      { text:"3:e deklinationen", anchor:"subst-dekl3" },
      { text:"Imperfekt", anchor:"verb-imperfekt" },
    ],
