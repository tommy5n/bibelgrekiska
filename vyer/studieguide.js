...
const PRINCIPER = [
  ...
  { rubrik:"Kongruens binder ihop frasen",
    text:"Artikel och adjektiv rättar sig efter sitt huvudord i genus, kasus och numerus. Ord som hör ihop bär samma böjning." },
...

  {
    ...
    begrepp:[
      ...
      { rubrik:"Nya modus: infinitiv och imperativ",
        text:"Hittills har verben stått i indikativ. <b>Infinitiven</b> (<span class='grek'>λύειν</span> ’att lösa’) är en oböjd grundform; <b>imperativen</b> (<span class='grek'>λῦε</span> ’lös!’) uttrycker befallning." },
