...
<header>
  ...
  <div class="sub" id="subtitle">seminarium 2–7 · grekiska → svenska</div>
</header>
...
const DECKS = [
  { id:"sem", namn:"Seminarium 2–7", desc:"Kursens ordlistor, seminarium 2–7." },
...
function uppdateraDackVy(){
  ...
  document.getElementById("subtitle").textContent =
    (state.deck === "60" ? "NT-frekvens > 60" : "seminarium 2–7") + " · grekiska → svenska";
