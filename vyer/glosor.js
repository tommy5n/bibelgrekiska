...
const GLOSOR = [
  ...
  {"l":"ἀλήθεια", "g":"sanning", "o":"substantiv", "gen":"f", "f":109, "s":[4, 5], "d":["sem", "60"]},
  ...
  {"l":"δέ", "g":"och, men", "o":"partikel", "gen":null, "f":2766, "s":[5], "d":["60"]},
  ...
  {"l":"ζητέω", "g":"söka, sträva efter, undersöka", "o":"verb", "gen":null, "f":117, "s":[4, 5], "d":["sem", "60"]},
  ...
  {"l":"πιστεύω", "g":"tro, lita på", "o":"verb", "gen":null, "f":241, "s":[3, 4, 5], "d":["sem", "60"]},
  ...
  {"l":"προφήτης", "g":"profet", "o":"substantiv", "gen":"m", "f":144, "s":[5], "d":["60"]},
  ...
  {"l":"τέκνον", "g":"barn", "o":"substantiv", "gen":"n", "f":99, "s":[3, 4, 5], "d":["sem", "60"]},
  ...
  {"l":"ἔρημος", "g":"öken", "o":"substantiv", "gen":"f", "f":48, "s":[5], "d":["sem"]},
...
const SEMINARIER = [2, 3, 4, 5];
const ORDKLASSER = [...new Set(GLOSOR.map(w => w.o))];   // i förekomstordning
const DECKS = [
  { id:"sem", namn:"Seminarium 2–5", desc:"Kursens ordlistor, seminarium 2–5." },
