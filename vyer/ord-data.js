// Delad orddata för ändelsespelet (#7) och paradigmspelet (#10).
...
export const ord = [
  ...
  { lemma:"διδάσκαλος", glosa:"lärare", glosaGen:"lärares", glosaPl:"lärare", genus:"m", sem:[6], former:{
    nom:{sg:"διδάσκαλος",pl:"διδάσκαλοι"}, gen:{sg:"διδασκάλου",pl:"διδασκάλων"}, dat:{sg:"διδασκάλῳ",pl:"διδασκάλοις"}, ack:{sg:"διδάσκαλον",pl:"διδασκάλους"}, vok:{sg:"διδάσκαλε",pl:"διδάσκαλοι"} }},
