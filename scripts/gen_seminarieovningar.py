...
<html lang="sv">
  <head>
    ...
    <style>
      ...
      .gr-bar .xref:hover {{ text-decoration: underline; }}
      .gr-layout {{
  ...
  <body>
    <header class="gr-bar">
      ...
      <a class="utskrift" href="seminarieovningar-utskrift.html">🖨 Utskriftsversion</a>
      <a class="xref" href="grammatikreferens.html">📘 Grammatikreferens</a>
    </header>
...
.ov-list thead th:last-child {{ padding-left: 3mm; }}
...
.ov-q {{ padding-right: 3mm; }}
/* Lodrät hårlinje = vikkant för pappersremsan; luft på båda sidor om den. */
.ov-a {{ border-left: 0.5pt solid #000; padding-left: 3mm; }}
.ov-num {{
