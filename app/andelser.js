...
function aktivaOrd(){ const v = ord.filter(o => state.valdaOrd.has(o.lemma)); return v.length ? v : ord; }
...
function spara(){
  try{ localStorage.setItem(LAGER, JSON.stringify({
    ...
    valdaOrd:[...state.valdaOrd], valdaKasus:[...state.valdaKasus], best:state.best,
  })); }catch(e){}
}
function ladda(){
  try{
